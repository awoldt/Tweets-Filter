...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Search for a user&apos;s most popular tweets</title>
        <link
      ...
      <Container>
        ...
        <p style={{ maxWidth: "400px" }}>
          ...
          <br></br>
          <br></br> All tweets returned are original posts, it will exclude all
          retweets and reply tweets.
        </p>
        ...
        <p className="text-secondary" style={{ marginTop: "100px" }}>
          All data gathered using Twitter API. This site has no affiliation with
          Twitter.
        </p>
